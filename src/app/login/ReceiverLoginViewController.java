...
public class ReceiverLoginViewController extends PageController{
    ...
    void ClickLogin(ActionEvent event) throws Exception {
		...
		if (Database.checkRecipientValid(userName, password)) {
			DialogAlert.showMessage("Successfull Login", "Loading Receiver Dashboard", AlertType.INFORMATION);
